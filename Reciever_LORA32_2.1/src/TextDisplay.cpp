...
const char HelloWorld[] = "SmartHive";
...
{
  Serial.println("hhelloWorldForDummies");
  const char text[] = "helloWorldForDummies";
  ...
  while (display.nextPage());
  Serial.println("helloWorldForDummies done");
}
